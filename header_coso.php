...
<nav class="navbar navbar-expand-custom navbar-mainbg">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="gv_dk.php"><i class="far fa-calendar-alt"></i>GIẢNG VIÊN ĐĂNG KÝ</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="rp_3.php"><i class="far fa-copy"></i>Xem Danh Sách Đăng Ký</a>
            </li>
        </ul>
    </div>
</nav>